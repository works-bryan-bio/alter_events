...
<section id="mast" style="position: fixed; background: none;">
	<div style="left: 0px; top: 0px; position: absolute; overflow: hidden; z-index: 1; margin: 0px; padding: 0px; height: 100%; width: 100%;">
		...
		?>
		<img  class="banner-inner" src="<?php echo $image_bg; ?>" style="position: absolute; margin: 0px; padding: 0px; border: none; z-index: -999999; width: 100%; height: 910.03px; left: 0px; top: -197.516px;">
	</div>
</section>
...
<div class="row">
	...
	<div class="col-md-12 center">
		<div class="page-content" id="blog-content">
			<div class="container-blog" style="margin-top: 25px !important;">
				<?php
